...
public class OssService {
    ...
    private OssUIDisplayer mDisplayer;
    private String mCallbackAddress;

    public OssService(OSS oss, String bucket, OssUIDisplayer uiDisplayer) {
        this.mOss = oss;
        this.mBucket = bucket;
    ...
    public void asyncResumableUpload(String resumableFilePath) {
        String mResumableObjectKey = "resumableObject";
    ...
    public void customSign(Context ctx, String objectKey) {
        OSSCustomSignerCredentialProvider provider = new OSSCustomSignerCredentialProvider() {
            ...
            public String signContent(String content) {
                ...
                String signedString = OSSUtils.sign(BaseConstant.AK, BaseConstant.SK, content);
                return signedString;
            }
        };
