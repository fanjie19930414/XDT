...
package com.kotlin.baselibrary.custom.LoopViewPager;
...
public class LoopViewPager extends ViewPager {
    ...
    public final void setOnPageChangeListener(OnPageChangeListener listener) {
        super.setOnPageChangeListener(buildOnPageChangeListener(listener));
    }

    @Override
    public void addOnPageChangeListener(@NonNull OnPageChangeListener listener) {
        super.addOnPageChangeListener(buildOnPageChangeListener(listener));
    }
    ...
    public int getInnerPosition(int position) {
        return mAdapter.toInnerPosition(position);
    }

    private OnPageChangeListener buildOnPageChangeListener(final OnPageChangeListener listener) {
